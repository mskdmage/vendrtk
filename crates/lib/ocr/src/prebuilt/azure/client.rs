...
// TODO: Sticking to the product name for now,
// lib + path should hint its an OCRClient implementation,
// but might change it later if we want to be more specific,
